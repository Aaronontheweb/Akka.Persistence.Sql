// -----------------------------------------------------------------------
//  <copyright file="SqliteDdlValidationSpec.cs" company="Akka.NET Project">
...
namespace Akka.Persistence.Sql.Tests.Sqlite
{
    ...
    public class SqliteDdlValidationSpec : DdlValidationSpecBase
    {
        protected override string ProviderName => "sqlite";

        public SqliteDdlValidationSpec(ITestOutputHelper output, MsSqliteContainer fixture)
            : base(output, fixture)
        {
        }
